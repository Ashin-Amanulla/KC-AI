...
const shiftPayHoursSchema = new mongoose.Schema(
  {
    ...
    otAfter76Weekday: { type: Number, default: 0 },
    otAfter76Saturday: { type: Number, default: 0 },
    otAfter76Sunday: { type: Number, default: 0 },
    otAfter76Holiday: { type: Number, default: 0 },
