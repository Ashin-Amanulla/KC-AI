      ...
      try {
        ...
        for (const [shiftId, bd] of shiftBreakdowns) {
          ...
          shiftPayHoursDocs.push({
            ...
            otAfter76Weekday: bd.otAfter76Weekday || 0,
            otAfter76Saturday: bd.otAfter76Saturday || 0,
            otAfter76Sunday: bd.otAfter76Sunday || 0,
            otAfter76Holiday: bd.otAfter76Holiday || 0,
